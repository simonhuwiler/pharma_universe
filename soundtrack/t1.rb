...
use_synth :hollow
play chord(:f3, :minor), attack: 5, sustain: 200, release: 2
...
with_synth :prophet do
  with_fx :reverb, room: 1, amp: 0.1, amp_slide: 5 do |fx|
    ...
    #play_pattern_timed [:f5, :c5, :gs4, :c5, :gs4, :f4, :gs4, :f4, :c4, :f4], 0.125, release: 0.2, attack: 0.05, cutoff: rrand(30, 90), amp: 1
    
  end
  
end

define :rythm_with_slight_bass do
  in_thread do
    with_synth :fm do
      with_fx :reverb do
        2.times do
